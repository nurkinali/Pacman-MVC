 ...
 * <h1>MovableGrid</h1>
 *
 * <p>A {@link MovableGrid} is a {@link Grid} located in a {@link GameMap} with the ability to move.
 *
...
public abstract class MovableGrid extends Grid {
   ...
   * GameMap}, and sets a random image of {@link MovableGrid}, and gives a initial {@link Direction#UP}
   * to move to.
   *
   * @param map the {@link GameMap} where this {@link MovableGrid} stays
   * @param row the row index in the {@link GameMap} where this {@link MovableGrid} stays, starting from
   *     0
   * @param column the column index in the {@link GameMap} where this {@link MovableGrid} stays,
   *     starting from 0
   ...
   */
  MovableGrid(GameMap map, double row, double column, MovableGridType movableGridType) {
   ...
   * retrieve) stays.
   *
   * <p>This method gets all {@link Portal}s from the parent {@link GameMap} and calls {@link
