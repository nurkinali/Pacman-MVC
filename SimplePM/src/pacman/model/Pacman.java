 ...
 * <h1>Pacman</h1>
 *
 * <p>A {@link Pacman} is a {@link MovableGrid} in a {@link GameMap}. It is the main character of the
...
public class Pacman extends MovableGrid {
   ...
   *
   * <p>This constructor sets the {@link Pacman} in the given position of the given {@link GameMap}, and
   * sets a image of {@link Pacman}.
   *
   * @param map the {@link GameMap} where this {@link Pacman} stays
   * @param row the row index in the {@link GameMap} where this {@link Pacman} stays, starting from 0
   * @param column the column index in the {@link GameMap} where this {@link Pacman} stays, starting
   *     from 0
   */
  public Pacman(GameMap map, double row, double column) {
    super(map, row, column, MovableGridType.PACMAN);

    this.setImage(ResourcesFileName.IMAGE_PACMAN);
  }
   ...
   *
   * <p>This method gets all {@link Cookie}s from the parent {@link GameMap} and calls {@link
